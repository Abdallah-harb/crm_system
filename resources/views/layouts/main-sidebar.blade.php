                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard">
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">CRM System</span>
                            </div>
                    ...
                    <!-- menu title -->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">Simple CRM System</li>
                    <!-- menu item Elements-->
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('user.index')}}">User Process</a></li>
                        </ul>
                    </li>
                    <!-- menu item calendar-->
                    <li>
